...
function Footer() {
  ...
  return (
    <footer className={`${
      isDarkMode 
        ? 'bg-gradient-to-r from-gray-900 via-gray-800 to-black border-t border-gray-700' 
        : 'bg-gradient-to-r from-gray-100 via-blue-50 to-indigo-50 border-t border-gray-200'
    }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#home" className={`transition duration-300 ${
                isDarkMode ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'
              }`}>Home</a></li>
              <li><a href="#about" className={`transition duration-300 ${
                isDarkMode ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'
              }`}>About</a></li>
              <li><a href="#how-to-play" className={`transition duration-300 ${
                isDarkMode ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'
              }`}>How to Play</a></li>
              <li><a href="#" className={`transition duration-300 ${
                isDarkMode ? 'text-gray-300 hover:text-cyan-400' : 'text-gray-600 hover:text-blue-600'
              }`}>Leaderboard</a></li>
            </ul>
          </div>
